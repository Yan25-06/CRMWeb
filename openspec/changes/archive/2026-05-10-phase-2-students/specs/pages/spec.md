# Delta Spec: Phase 2 — Quản Lý Học Sinh

## ADDED Requirements

### Requirement: StudentsPage Layout
...
### Requirement: Danh sách học sinh
...
### Requirement: Modal Thêm/Sửa Học Sinh
...
### Requirement: Danh sách lớp học (Grid View)
...
### Requirement: Modal Thêm/Sửa Lớp
- Fields bổ sung: 
  - Tên lớp (required)
